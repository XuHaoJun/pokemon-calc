...
def create_prompt(question: str) -> str:
  ...
  parts.append('12. Do not generate MongoDB query like: "{"$elemMatch": {"$and": []}}" should use "$all", correct: "{"$elemMatch": {"$all": []}}" incorrect: "{"$elemMatch": {"$and": []}}".')
  parts.append('13. Do not full object match should partial match properties, correct: "{"move.name": "abc"}", incorrect: "{"move": {"name": "abc"}}".')
